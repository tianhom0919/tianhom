...
Or alternatively. click [here](./downloads/Dockerfile.rzg_ubuntu-20.04).
...
```
:::warning
Please move the two patch files **0001-gstreamer-moil-plugin.patch** and **0002-fix_qtsmarthome_url.patch** into the `yocto` directory.
:::
